...
def detect_white_shapes(frame, lower_white=(0, 0, 200), upper_white=(180, 25, 255), contour_color=(0, 255, 0), contour_thickness=2):
    """Обнаруживает белые фигуры на изображении и возвращает их контуры."""
...
def process_and_recognize_texts(squares_folder):
    """Проходит по сохраненным изображениям в папке и распознает текст на армянском языке."""
...
def main():
    ...
    with ThreadPoolExecutor() as executor:
        while True:
            ...
            future_recognize_text = executor.submit(process_and_recognize_texts, squares_folder)
